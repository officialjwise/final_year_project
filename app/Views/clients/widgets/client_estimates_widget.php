<div class="card bg-white">
    <span class="p-4"><?php echo app_lang("institutions"); ?></span>

    <div class="card-body pt0 rounded-bottom" id="estiamte-widget-container">
        <ul class="list-group list-group-flush">
            <a class="institution-widget-link" data-filter="has_open_estimates" href="<?php echo get_uri("clients/index/clients_list#has_open_estimates"); ?>">
            ...
            <a class="institution-widget-link" data-filter="has_accepted_estimates" href="<?php echo get_uri("clients/index/clients_list#has_accepted_estimates"); ?>">
            ...
            <a class="institution-widget-link" data-filter="has_new_estimate_requests" href="<?php echo get_uri("clients/index/clients_list#has_new_estimate_requests"); ?>">
                <li class="list-group-item border-top text-default">
            ...
            <a class="institution-widget-link" data-filter="has_estimate_requests_in_progress" href="<?php echo get_uri("clients/index/clients_list#has_estimate_requests_in_progress"); ?>">
                <li class="list-group-item border-top text-default">
