...
<?php
// Rename all UI references from 'client' to 'institution' for user-facing text, labels, and dropdowns.
// For example:
// app_lang('client') -> app_lang('institution')
// app_lang('clients') -> app_lang('institutions')
?>