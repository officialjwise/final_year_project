...
<a class="institution-widget-link" data-filter="<?php echo $link; ?>" href="<?php echo get_uri("clients/index/clients_list#$link"); ?>">
    <div class="card">
        <div class="card-body p20">
            ...
            <div class="clearfix">
                <span class="text-off float-start mt-3 text-default"><?php echo $progress . "% " . app_lang("of_total_institutions"); ?></span>
