    ...
    <div class="form-group">
        <div class="row">
            ...
            <div class="<?php echo $field_column; ?>">
                ...
                ?>
                <div class="help-block ml10"><small><?php echo app_lang('permissions_help_message'); ?></small></div>
            </div>
        </div>
    </div>
    
    <!-- Institution User Management Permission -->
    <div class="form-group">
        <div class="row">
            <div class="<?php echo $field_column; ?> ms-auto">
                <?php 
                $has_management_permission = isset($user_info) && strpos($user_info->client_permissions, 'institution_user_management') !== false;
                echo form_checkbox("institution_user_management$contact_suffix", "1", $has_management_permission, "id='institution_user_management$contact_suffix' class='form-check-input mt-2'");
                ?>
                <label for="institution_user_management<?php echo $contact_suffix; ?>" class="ml15"><?php echo app_lang('can_manage_institution_users'); ?></label>
                <div class="help-block ml15"><small><?php echo app_lang('institution_user_management_help'); ?></small></div>
            </div>
        </div>
    </div>
</div>
